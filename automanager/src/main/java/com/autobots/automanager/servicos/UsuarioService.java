...
import com.autobots.automanager.modelos.outro.SelecionadorUsuario;
import com.autobots.automanager.modelos.outro.VerificadorPermissao;
...
public class UsuarioService {
    ...
    public List<Usuario> listarUsuarios(String username) {
        ...
        if (usuarioLogado.getPerfis().contains(Perfil.ROLE_GERENTE)) {
            usuarios = selecionadorUsuario.selecionarPorCargo(usuarios, Perfil.ROLE_GERENTE);
        } else if (usuarioLogado.getPerfis().contains(Perfil.ROLE_VENDEDOR)) {
            usuarios = selecionadorUsuario.selecionarPorCargo(usuarios, Perfil.ROLE_VENDEDOR);
        } else if (usuarioLogado.getPerfis().contains(Perfil.ROLE_CLIENTE)) {
    ...
    public Usuario visualizarUsuario(Long id, String username) {
        Usuario usuarioAlvo = repositorioUsuario.findById(id).orElse(null);
        if (usuarioAlvo == null) return null;
        ...
        throw new SecurityException("Usuário sem permissão para visualizar este cadastro.");
    }

    public Usuario visualizarUsuarioPorUsername(String username) {
        List<Usuario> usuarios = repositorioUsuario.findAll();
    ...
    public void cadastrarUsuario(String username, UsuarioDTO usuario) {
        ...
        boolean permissao = verificadorPermissao.verificar(usuarioLogado.getPerfis(),usuario.perfis(), "CREATE");
    ...
    public void vincularUsuarioEmpresa(Long idUsuario, Long idEmpresa, String username) {
        ...
        boolean permissao = verificadorPermissao.verificar(usuarioLogado.getPerfis(), usuario.getPerfis(), "CREATE");
    ...
    public ResponseEntity<?> atualizarUsuario(Long id, AtualizarUsuarioDTO usuario, String username) {
        ...
        if (usuarioAtual != null) {
            ...
            boolean permissao = verificadorPermissao.verificar(usuarioLogado.getPerfis(), usuarioAtual.getPerfis(), "UPDATE");
    ...
    public void deletarUsuario(Long id, String username) {
        ...
        boolean permissao = verificadorPermissao.verificar(usuarioLogado.getPerfis(), usuario.getPerfis(), "DELETE");
