...
import com.autobots.automanager.modelos.adicionador.AdicionadorLinkCredencial;
...
public class CredencialServico {
    ...
    public Credencial listarCredenciaisUsuario(Long idUsuario, String username) {
        ...
        boolean permissao = verificadorPermissao.verificar(usuarioSelecionado.getPerfis(), usuario.getPerfis(), "READ");
    ...
    public void cadastrarCredencial (Long idUsuario, CredencialDTO credencial, String username) {
        ...
        boolean permissao = verificadorPermissao.verificar(usuarioSelecionado.getPerfis(), usuario.getPerfis(), "CREATE");
    ...
    public void atualizarCredencial(Long id, CredencialDTO credencial, String username) {
        ...
        boolean permissao = verificadorPermissao.verificar(usuarioSelecionado.getPerfis(), usuarioAtualizado.getPerfis(), "UPDATE");
