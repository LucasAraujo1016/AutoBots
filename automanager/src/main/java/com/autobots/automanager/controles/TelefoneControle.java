...
import com.autobots.automanager.modelos.telefone.TelefoneCadastrar;
import com.autobots.automanager.modelos.telefone.TelefoneRemovedor;
...
public class TelefoneControle {
    ...
    @Autowired
    private TelefoneCadastrar telefoneCadastrador;
    ...
    public ResponseEntity<Telefone> visualizarTelefone(@PathVariable long id){
        ...
        if (telefone == null) {
            ...
            ResponseEntity<Telefone> resposta = new ResponseEntity<>(telefone, HttpStatus.OK);
            return resposta;
        }
    }
    ...
    public ResponseEntity<?> removerTelefone(@RequestBody List<Telefone> telefone,@PathVariable long clienteid){
        ...
        if (cliente == null){
            ...
            telefoneRemovedor.remover(cliente, telefone);
            clienteRepositorio.save(cliente);
